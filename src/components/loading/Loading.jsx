...
const LoadingBackground = styled.div`
  ...
  .symbol {
    ...
    stroke-dashoffset: 600;
    animation: ${symbolAnim} 2s linear forwards;
  }
  .dot {
    stroke-dasharray: 465;
    stroke-dashoffset: 465;
    animation: ${dotAnim} 3s linear forwards;
  }
  #miLogo {
    animation: ${paper} 4.5s linear forwards;
  }
`
  ...
  return (
    <LoadingBackground>
      <svg
        ...
        enableBackground="new 106 -106 512 512"
        space="preserve"
      >
        <polygon
          fill="#2a323f"
